...
# ----------------------
  ...
  it '5. finds multiple items by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    items = Item.order(:created_at).find(ids_to_find)
    # binding.pry
    # ------------------------------------------------------------
  ...
  it '6. finds multiple orders by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    orders = Order.order(:created_at).find(ids_to_find)
    # ------------------------------------------------------------
  ...
  it '7. finds orders with an amount between 700 and 1000' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    orders_between_700_and_1000 = Order.where("700 <= amount AND amount <= 1000").to_a
    # binding.pry
    # ------------------------------------------------------------
